...
- (void)attributedStrikethroughText:(NSString *)mainText withBlackText:(NSString *)blackText {
    ...
    [attributeString addAttribute:NSStrikethroughColorAttributeName value:C_LightGray_999999 range:range];
...
- (void)attributedTwoBlackText:(NSString *)mainText
    ...
    [attributeString addAttribute:NSForegroundColorAttributeName value:C_Black_333333 range:range_first];
    [attributeString addAttribute:NSForegroundColorAttributeName value:C_Black_333333 range:range_second];
    self.attributedText = attributeString;
}
